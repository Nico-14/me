  ...
  return (
    <Layout>
      <article className="w-full max-w-2xl">
        <h1 className="text-indigo-500 text-4xl sm:text-5xl">Contacto</h1>
        <section>
          <form className="flex flex-col gap-y-4 mt-10" onSubmit={handleSubmit}>
            <input
              ...
              type="email"
              name="email"
              className="outline-none py-2 px-4 border-2 border-indigo-400"
              required
              maxLength="320"
              value={email}
            ...
            ></input>
            <textarea
              className="resize-none outline-none py-2 px-4 border-2 border-indigo-400"
              rows="10"
              required
              maxLength="1400"
              value={text}
            ...
            <button
              className={`bg-indigo-500 text-white rounded px-4 py-2 ${
                isSending ? 'opacity-70 cursor-default' : 'hover:opacity-95'
              }`}
              disabled={isSending}
            >
              Enviar
        ...
        <section>
          <nav className="flex justify-center mt-10 gap-x-3">
            <IconLink href="https://www.linkedin.com/in/mateo-ledesma/">
              <svg
            ...
            <IconLink href="https://instagram.com/null14__">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <IconLink href="https://wa.me/5493435047916">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                className="w-6 h-6 text-white"
            ...
            <IconLink href="mailto:mateo.14.ledesma@gmail.com">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
