  ...
  return (
    <Layout>
      <section>
        ...
        <h1 className="text-indigo-600 text-4xl sm:text-5xl mt-6 dark:text-indigo-700">Mateo Ledesma</h1>
        <p className="text-xl sm:text-2xl text-gray-500  dark:text-gray-300 mt-1">
